...
//        return jdbcTemplate.queryForObject("SELECT * FROM users WHERE email=?", ROW_MAPPER, email);
    ...
    public List<User> getAll() {
        ...
        jdbcTemplate.query("SELECT * FROM user_roles", records -> {
            map.computeIfAbsent(records.getInt("user_id"), userId -> EnumSet.noneOf(Role.class)).add(Role.valueOf(records.getString("role")));
        });
